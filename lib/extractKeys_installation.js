 ...
 */
 async function addDataPoint(adapter, name, value) {
    try{
        var typ = "mixed";
        ...
        //create the object
        await adapter
            .setObjectNotExistsAsync("installation." + name, {
                type: "state",
                common: {
                    name: name,
                    read: true,
        ...
        //set the value    
        adapter.setState("installation." + name, value, true);
